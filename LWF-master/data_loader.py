...
class cifar100(cifar10):
	base_folder = 'cifar-100-python'       #如果是下载到本地，可以注释该行
	url = "http://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz"    #如果是下载到本地，可以注释该行
	...
	#其中tgz_md5也可注释掉，MD5是一种消息摘要加密算法，torch使用这个估计是为了下载数据集时防止木马病毒入侵篡改文件，由于我们已经下载好，故不需要了。
	meta = {
		'filename': 'meta',
